      ...
      <div className="container px-10 py-20 mx-auto ">
        <div className="flex md:items-center lg:justify-between lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col sm:flex mb-4">
          ...
          <div className="sm:w-1/2 sm:mt-0 lg:mt-16 h-auto lg:w-2/6 md:w-1/2 w-full ml-4">
            <div className="text-white mb-1">Subscribe to your Newsletter</div>
            <div className="flex flex-wrap lg:space-x-3 md: space-x-3 sm:space-y-3 lg:space-y-0 md:space-y-0 mb-4">
              <input
                type="text"
                class="p-2 border border-white rounded-md bg-transparent text-white text-sm h-auto"
                placeholder="Your Email "
              />
              <button className="bg-white text-gray-900 sm:mt-2 sm:ml-0 lg:mt-0 rounded-md h-auto text-xs p-3 ml-3 sm:space-y-3 lg:space-y-0 md:space-y-0">
                Subscribe
              </button>
            </div>

            <div className="mt-16">
              <div className="text-white mb-1">Follow Us</div>
