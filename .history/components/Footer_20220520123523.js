  ...
  return (
    <footer className="bg-secondary-900">
      <div className="container px-10 py-20 mx-auto ">
        <div class="flex md:items-center lg:justify-between lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col sm:flex mb-4">
          <div class="sm:w-1/4 h-auto lg:w-2/6 md:w-1/2 w-full px-2">
          ...
          <div class="sm:w-1/4 h-auto sm:mt-0 mt-8 lg:w-2/6 md:w-1/2 w-full ml-4 mb-4">
          ...
          <div class="sm:w-1/2 sm:mt-0 lg:mt-16 h-auto lg:w-2/6 md:w-1/2 w-full ml-4">
